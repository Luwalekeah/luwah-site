...
const doc = {
  ...
  tiers: [
    ...
    { _key: "tier-3", key: "tier-3", name: "Tier 3", price: 3000, priceLabel: "$3,000", pages: "Full Platform", summary: "Everything, plus payments and a CMS.", includedAddons: ["stripe", "sanity-cms", "sentry", "resend", "multi-user"], features: ["Everything in Tier 2", "Stripe payment integration", "Sanity CMS for blog and pages", "Sentry errors, Plausible analytics", "Resend email, Cloudflare WAF", "90 days of priority support"] },
  ],
  addons: [
    { _key: "managed-hosting", key: "managed-hosting", name: "Managed hosting (Render)", oneTime: 0, oneTimeLabel: "No setup fee", monthlyLabel: "From $10/mo" },
    { _key: "spreadsheet-leads", key: "spreadsheet-leads", name: "Spreadsheet lead capture", oneTime: 80, oneTimeLabel: "+$80 per sheet", variable: true },
    { _key: "local-seo", key: "local-seo", name: "Local SEO setup", oneTime: 0, oneTimeLabel: "Priced per project", variable: true },
    { _key: "stripe", key: "stripe", name: "Stripe payments", oneTime: 300, oneTimeLabel: "+$300", monthlyLabel: "2.9% + $0.30/tx", includedIn: ["tier-3"] },
    { _key: "sanity-cms", key: "sanity-cms", name: "Sanity CMS / blog module", oneTime: 300, oneTimeLabel: "+$300", includedIn: ["tier-3"] },
    { _key: "sentry", key: "sentry", name: "Sentry error tracking", oneTime: 100, oneTimeLabel: "+$100", includedIn: ["tier-3"] },
    { _key: "resend", key: "resend", name: "Resend transactional email", oneTime: 200, oneTimeLabel: "+$200", includedIn: ["tier-3"] },
    { _key: "slack", key: "slack", name: "Slack notifications", oneTime: 100, oneTimeLabel: "+$100" },
    { _key: "twilio", key: "twilio", name: "Twilio SMS", oneTime: 200, oneTimeLabel: "+$200" },
    { _key: "multi-user", key: "multi-user", name: "Multi-user admin accounts", oneTime: 200, oneTimeLabel: "+$200", includedIn: ["tier-3"] },
  ],
  supportPlans: [
    ...
    { _key: "light", key: "light", name: "Light Support", priceLabel: "$100/mo", includes: "Email support (24-hr response), 4 hrs/mo customization, monthly check-ins." },
