...
const GUIDES = [
  ...
  g("vlan", "What is a VLAN?", "Networking", 1,
    "A Virtual LAN splits one physical network into separate, isolated networks.",
    ["A VLAN lets you divide a single network into groups that cannot see each other, even though they share the same hardware.",
     "## Why it matters",
     "It is used for security and organization. For example, guest WiFi, office computers, and security cameras can each live on their own VLAN so a problem on one does not reach the others."]),
  g("ip-address", "What is an IP Address?", "Networking", 2,
  ...
  g("firewall", "What is a Firewall?", "Networking", 3,
    ...
    ["A firewall checks incoming and outgoing connections against rules and blocks anything that is not allowed.",
     "It is a first line of defense against attacks, and every site and server we run sits behind one."]),
  g("server-rack", "What is a Server Rack?", "Hardware", 1,
    "A standardized frame that holds servers, switches, and other gear in one place.",
    ["A server rack is a metal frame, measured in standard units called U, that stacks computing equipment vertically to save space and keep it organized.",
     "## Where you see them",
     "Data centers and on-premise server rooms use racks to house the machines that run websites, apps, and internal systems with proper power, cooling, and cable management."]),
  g("server", "What is a Server?", "Hardware", 2,
    "A computer that runs all the time to deliver websites, apps, or files to others.",
    ["A server is a computer built to stay on and respond to requests. When you visit a website, a server somewhere sends the pages to your browser.",
     "It can be a physical machine in a rack, a virtual slice of one (a VPS), or a managed service in the cloud."]),
];
